...
![echo](handle-with-curl-images/echo.png)
...
![transferclient](handle-with-curl-images/transferclient.png)
...
![gfclient_high](handle-with-curl-images/gfclient_high.png)
...
![gfc_perform](handle-with-curl-images/gfc_perform.png)
...
![gfserver_high](handle-with-curl-images/gfserver_high.png)
...
![gfserver_serve](handle-with-curl-images/gfserver_serve.png)
...
![gfserver_sendheader](handle-with-curl-images/gfserver_sendheader.png)

![gfserver_send](handle-with-curl-images/gfserver_send.png)
...
![mtgf_driver](handle-with-curl-images/mtgf_driver.png)
...
![gfserver_main](handle-with-curl-images/gfserver_main.png)
...
![handler](handle-with-curl-images/handler.png)
